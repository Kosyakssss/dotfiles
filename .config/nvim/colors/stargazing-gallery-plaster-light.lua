-- Stargazing Gallery Plaster Light for Neovim
...
vim.g.colors_name = "stargazing-gallery-plaster-light"
...
hl("FzfLuaNormal", { fg = c.tx, bg = c.bg_2 })
hl("FzfLuaBorder", { fg = c.tx, bg = c.bg_2 })
hl("FzfLuaTitle", { fg = c.tx, bg = c.bg_2 })
hl("FzfLuaCursor", { fg = c.tx, bg = c.ui })
hl("FzfLuaCursorLine", { bg = c.bg_2 })
